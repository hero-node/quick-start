...
public abstract class HeroDrawerActivity extends HeroHomeActivity {
    ...
    private void initDrawerListener() {
        drawerLayout.addDrawerListener(new DrawerLayout.DrawerListener() {
            ...
            public void onDrawerOpened(View drawerView) {
               postDrawerStatus(true);
            }

            @Override
            public void onDrawerClosed(View drawerView) {
                postDrawerStatus(false);
            }
    ...
    private void postDrawerStatus(boolean opened) {
        JSONObject eventObj = new JSONObject();
        try {
            JSONObject sideBarValueObj = new JSONObject();
            sideBarValueObj.put("opened",opened);
            eventObj.put("event","sidebar");
            eventObj.put("value",sideBarValueObj);
            HeroDrawerActivity.this.on(eventObj);
