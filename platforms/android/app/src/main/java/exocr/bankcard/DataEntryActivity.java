...
public final class DataEntryActivity extends Activity implements TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (capture != null) {
            ...
            LinearLayout.LayoutParams bankNameETParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
            ...
            cardView.setImageBitmap(exocr.bankcard.CardRecoActivity.markedCardImage);
            ...
            if(capture.strNumbers != ""){
            	...
            	LinearLayout.LayoutParams resultLayoutParams = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
